...
<template >
  <div class="Primary">
    <header class="header">
      <VButtonArrowLeft />
      <VtitlePage :title="`Perfil`" />
      <button class="buttonIcon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#626463" class="bi bi-gear-fill" viewBox="0 0 16 16">
