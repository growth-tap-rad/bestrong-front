...
import VButtonBottomOptions from './VButtonBottomOptions.vue';
import { ref } from 'vue';
...
<template>
  <div class="footer">
    <VButtonBottomOptions :show="show" :class="{ 'button-bottom-bptions': show }" />

    <div class="buttons-options">
      <div class="buttons-options-children">
        <button class="botoesBarraInferior" :class="{ 'active': actualRoute === '/diet' }" @click="goTo('/diet')"><svg
          ...
          <span class="text" v-show="actualRoute === '/diet'">Dieta</span>
        </button>
        <button class="botoesBarraInferior" :class="{ 'active': actualRoute === '/train' }" @click="goTo('/train')"><svg
            xmlns="http://www.w3.org/2000/svg" height="1em"
      ...
      <div class="buttons-options-children">
        ...
        <button class="botoesBarraInferior"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
    ...
    <button @click="showButtonBottomOptions" class="botoesBarraInferior botaoMais" :class="{ 'deitado': show }">+</button>
  </div>
</template>
...
.botoesBarraInferior.active svg path {
  fill: var(--text-color-highlighted2);
}
