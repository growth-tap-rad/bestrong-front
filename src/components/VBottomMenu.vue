  ...
  <div class="footer">
    ...
    <div class="buttons-options">
      <div class="buttons-options-children">
        <button class="botoesBarraInferior" :class="{ active: actualRoute === '/diet' }" @click="goTo('/diet')">
        ...
        <button class="botoesBarraInferior" :class="{ active: actualRoute === '/trains' }" @click="goTo('/trains')">
      ...
      <div class="buttons-options-children">
        <button class="botoesBarraInferior" :class="{ active: actualRoute === '/profile' }" @click="goTo('/profile')">
          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            <path
    ...
    <button @click="showButtonBottomOptions" class="botoesBarraInferior botaoMais"
