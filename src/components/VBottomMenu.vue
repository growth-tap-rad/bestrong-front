  ...
  <div class="footer">
    <div class="buttons-options">
      <div class="buttons-options-children">
        <button class="botoesBarraInferior" :class="{'active': actualRoute === '/diet'}"  @click="goTo('/diet')"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
        ...
        <button class="botoesBarraInferior" :class="{'active': actualRoute === '/train'}" @click="goTo('/train')"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
